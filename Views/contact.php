				...
				<div class='col-lg-8 contact_col'>
					<div class='get_in_touch'>
						<div class='contact_form_container'>
							<form action='../Controler/reponse.php' id='contact_form' class='contact_form' method='POST'>
								<div class='row'>
									<div class='col-xl-6'>
										<!-- Name -->
			...
			<div class='row'>
				...
				<div class='col-lg-8 contact_col'>
					<div class='get_in_touch'>
						...
						<div class='contact_form_container'>
							<form action='..\Controler\message.php' id='contact_form' class='contact_form' method='POST'>
								<div class='row'>
									<div class='col-xl-6'>
										<!-- Name -->
