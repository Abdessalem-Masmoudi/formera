	...
	<div class="product_details">
		<div class="container">
			<div class="row details_row">
				...
				<?php
						/*$p=new produit();
							$res=$p->Rechproduit($_GET['id']);
							$row=$res->fetch();
						echo  "
				<div class='col-lg-6'>
					<div class='details_image'>
						<div class='details_image_large'><img src='$row[4]' alt=''><div><a href='categories.php'>New</a></div></div>
					</div>
				</div>
				...
				<div class='col-lg-6'>
					<div class='details_content'>
						...
						<div class='details_price'>$$row[2]</div>
						...
						<div class='product_quantity_container'>
							...
							<form action='../Controler/traitcart.php' method='post' >
								<span>Qty</span>
								<input type='text' value='$row[0]' name='id' hidden>
								<input id='quantity_input' type='text' pattern='[0-9]*' value='1' name='qt'>
