...
<div class="home">
	<div class="champAyman" >
		<div class="formAyman">		
			...
			<table>
                <form method="POST" action="..\Controler\trait.php">
                    <tr>
                        <td>Nom</td><td><input type="text" name="First_Name" class="login"/></td>
                    </tr>
                    <tr>
                        <td>prenom</td><td ><input type="text"name="Last_Name" class="login"/></td>
                    </tr>
                	<tr>
                    	<td>Email</td><td><input type="email" name="Email" class="login"/></td>
                	</tr>
                    <tr>
                		<td>Centre d'interet</td><td><select name="Centre[]" class="login" multiple><option>Html</option><option>css</option><option>php</option></select></td>
                	</tr>
                	<tr>
                		<td>Password</td><td ><input type="password"name="Password" class="login"/></td>
                	</tr>
                	<tr>
                    	<td>Confirm Password</td><td><input type="password" name="rePassword" class="login"/></td>
                	</tr>
                	<tr>
