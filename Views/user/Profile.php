		...
		<div class="formAyman">		
			...
			<table>
                ...
                <input hidden type="text" name="id" class="login" value="<?php echo $row[0] ?>"/>
                    <tr>
                        <td>Nom</td><td><input type="text" name="First_Name" class="login" value="<?php echo $row[1] ?>"/></td>
                    </tr>
                    <tr>
                        <td>prenom</td><td ><input type="text"name="Last_Name" class="login" value="<?php echo $row[2] ?>"/></td>
                    </tr>
                	<tr>
                    	<td>Email</td><td><input type="email" name="Email" class="login" value="<?php echo $row[3]?>"/></td>
                    </tr>
                    <?php 
                        $set=explode(',',$row[5]);
                    ?>
                    <tr>
                		<td>Centre d'interet</td><td><select name="Centre[]" class="login" multiple><?php if(in_array('Protein',$set)){echo"<option selected>Protein</option>";}else{echo"<option>Protein</option>";};if(in_array('WeightLifting',$set)){echo"<option selected>WeightLifting</option>";}else{echo"<option>WeightLifting</option>";};if(in_array('BodyBuilding',$set)){echo"<option selected>BodyBuilding</option>";}else{echo"<option>BodyBuilding</option>";}; ?></select></td>
                	</tr>
                	<tr>
                		<td>Password</td><td ><input type="password"name="Password" class="login" value="<?php echo $row[4]?>"/></td>
                	</tr>
                    <tr>
                		<td>Confirm Password</td><td ><input type="password"name="rePassword" class="login" value="<?php echo $row[4]?>"/></td>
                	</tr>
                	<tr>
