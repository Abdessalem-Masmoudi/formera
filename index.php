				...
				<ul class="page_menu_nav menu_mm">
					<li class="page_menu_item has-children menu_mm">
						...
						<ul class="page_menu_selection menu_mm">
							...
							<li class="page_menu_item menu_mm"><a href="views/formation.php">Formation<i class="fa fa-angle-down"></i></a></li>
							<li class="page_menu_item menu_mm"><a href="views/contact.php">contact<i class="fa fa-angle-down"></i></a></li>
							<li class="page_menu_item menu_mm"><a href="views/inscription.php">inscription<i class="fa fa-angle-down"></i></a></li>
						</ul>
					</li>
					<!--<li class="page_menu_item has-children menu_mm">
		...
		<div class="home_slider_container">
			...
			<div class="owl-carousel owl-theme home_slider">
				...
				<div class="owl-item home_slider_item">
					<div class="home_slider_background" style="background-image:url(Views/images/homeslider.jpg)"></div>
							...
							<div class="row">
								<div class="col">
									<div class="home_slider_content"  data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
										...
										<div class="button button_light home_button"><a href="views/inscription.php">Apply now</a></div>
									</div>
								</div>
							</div>
						</div>
...
<div class="avds">
		<div class="avds_container d-flex flex-lg-row flex-column align-items-start justify-content-between">
			<div class="avds_small">
				<div class="avds_background" style="background-image:url(Views/images/small.jpg)"></div>
				<div class="avds_small_inner">
					<div class="avds_discount_container">
						<img src="Views/images/discount.png" alt="">

					</div>
					<div class="avds_small_content">
						<div class="avds_title">Sharping Minds</div>
						<div class="avds_link"><a href="views/login.php">******Log in******</a></div>
					</div>
				</div>
			</div>
			<div class="avds_large">
				<div class="avds_background" style="background-image:url(Views/images/avds_large.jfif)"></div>
				<div class="avds_large_container">
					<div class="avds_large_content">
						...
						<div class="avds_link avds_link_large"><a href="views/formation.php">******See More******</a></div>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row icon_box_row">
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="Views/images/icon_2.svg" alt=""></div>
				...
				<div class="col-lg-4 icon_box_col">
					<div class="icon_box">
						<div class="icon_box_image"><img src="Views/images/icon_3.svg" alt=""></div>
	...
	<footer class="footer">
		<div class="footer_background" style="background-image:url(Views/images/footer2.jpg)"></div>
		<div class="container">
			<div class="row">
				<div class="col">
